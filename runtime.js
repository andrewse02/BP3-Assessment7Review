...
Looking at the initial results, it is clear that doublerAppend() is much more efficient than doublerInsert()
On occasion, doublerInsert() was faster. However, this only happens due to the small input size. As the functions scale,
doublerAppend() is clearly more efficient when handling larger input. Looking at the results, the shape of the graph is much steeper
for doublerInsert(), indicating that it scales much more inefficiently.
